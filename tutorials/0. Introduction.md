...
Nitrain is a library that makes it easier to train effective AI models on medical imaging datasets. It provides a full end-to-end solution for medical imaging AI, from reading in data from file, loading data batches into models with augmentation, running a training procedure locally or in the cloud, to explaining and visualizing model results.

This short overview will take you through all the key components of nitrain:
